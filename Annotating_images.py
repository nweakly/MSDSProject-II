# Writing image annotations for training a YOLO model 
# into an xml file
# has to have "Drawing_Boxes.py" file saved in the same directory

# Adapted from https://github.com/markjay4k/YOLO-series/blob/master/part7%20-%20generate_xml.py
# by Mark Jay
