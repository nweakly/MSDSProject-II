# Training data collection using Google search

# Adapted from https://github.com/markjay4k/YOLO-series/blob/master/part5%20-%20get_images.py
# by Mark Jay
...
headers = {'User-Agent': 'Chrome/41.0.2228.0 Safari/537.36'} # using Chrome

#function to get links to the images
def get_links(search_name):
    """ returns links to the images
    """
...
def save_images(links, search_name):
    """ downloads images from the links collected by the search_name function
    """
...
if __name__ == '__main__':
    search_name = 'crowbar tool' #use different search strings to get more results
